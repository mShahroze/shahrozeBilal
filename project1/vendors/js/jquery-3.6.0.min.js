!(function (e, t) {
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && k(t, 'input') && Se(t, 'click', we),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && k(t, 'input') && Se(t, 'click'), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function He(e, t, n, r) {
    ...
    var i,
      ...
      v = t[0],
      y = h(v);
    if (y || (p > 1 && 'string' == typeof v && !d.checkClone && Ae.test(v)))
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = ze(s)), (a = b.cssHooks[t] || b.cssHooks[s]), void 0 === n)
        )
  ...
  function at(e, t, n) {
    for (
      var r,
        i = (st.tweeners[t] || []).concat(st.tweeners['*']),
        o = 0,
        a = i.length;
      o < a;
      o++
  ...
  b.extend(b.event, {
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !p.noBubble && !g(r)) {
          for (
            u = p.delegateType || m, vt.test(u + m) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            y.push(a), (s = a);
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = r[l]) && (r[l] = null),
              (b.event.triggered = m),
              t.isPropagationStopped() && d.addEventListener(m, yt),
              r[m](),
              t.isPropagationStopped() && d.removeEventListener(m, yt),
      ...
      ajax: function (t, n) {
        ...
        d.hasContent
          ? d.data &&
            ...
            (d.data = d.data.replace(kt, '+'))
          : ((p = d.url.slice(i.length)),
            d.data &&
              (d.processData || 'string' == typeof d.data) &&
              ((i += (bt.test(i) ? '&' : '?') + d.data), delete d.data),
            !1 === d.cache &&
              ((i = i.replace(Nt, '$1')),
              (p = (bt.test(i) ? '&' : '?') + '_=' + xt.guid++ + p)),
            (d.url = i + p)),
        d.ifModified &&
          (b.lastModified[i] &&
  ...
  b.ajaxSetup({
    ...
    b.each(['top', 'left'], function (e, t) {
      b.cssHooks[t] = Fe(d.pixelPosition, function (e, n) {
        if (n)
          return (n = We(e, t)), Pe.test(n) ? b(e).position()[t] + 'px' : n;
      });
    }),
