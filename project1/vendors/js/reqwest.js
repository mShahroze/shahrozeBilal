    ...
    xhr = function (o) {
      ...
      if (o['crossOrigin'] === true) {
        ...
        if (xhr && 'withCredentials' in xhr) {
          ...
          if (
            window.location.href.match(protocolRegExp)[0] !==
            o.url.match(protocolRegExp)[0]
          ) {
            throw new Error(
              'XDomainRequest: requests must be targeted to the same scheme as the hosting page.'
            );
