        ...
        function (require, module, exports) {
          ...
          function isPoly(l) {
            return (
              ...
              ['Polygon', 'MultiPolygon'].indexOf(l.feature.geometry.type) !==
                -1
            );
          }
        ...
        function (require, module, exports) {
          (function () {
            ...
            gju.pointInPolygon = function (p, poly) {
              ...
              for (var i = 0; i < coords.length; i++) {
                if (
                  gju.pointInBoundingBox(
                    p,
                    boundingBoxAroundPolyCoords(coords[i])
                  )
                )
                  insideBox = true;
              }
                ...
                for (var j = 0; j < coords.length; j++) {
                  if (!insideBox) {
                    if (
                      gju.pointInBoundingBox(
                        p,
                        boundingBoxAroundPolyCoords(coords[j])
                      )
                    ) {
                      insideBox = true;
                    }
            ...
            (gju.area = function (polygon) {
              ...
              (gju.simplify = function (source, kink) {
                ...
                band_sqr =
                  (kink * 360.0) /
                  (2.0 * Math.PI * 6378137.0); /* Now in degrees */
                band_sqr *= band_sqr;
                n_dest = 0;
                sig_start[0] = 0;
          ...
          either side of line joining start & end points */
                    ...
                    for (
                      i = start + 1, sig = start, max_dev_sqr = -1.0;
                      i < end;
                      i++
                    ) {
                      ...
                      x13 *= Math.cos(
                        F * (source[i].lat() + source[start].lat())
                      );
                      d13 = x13 * x13 + y13 * y13;
                      ...
                      if (d13 >= d12 + d23) dev_sqr = d23;
                        ...
                        dev_sqr =
                          ((x13 * y12 - y13 * x12) * (x13 * y12 - y13 * x12)) /
                          d12; // solve triangle
            ...
            gju.destinationPoint = function (pt, brng, dist) {
              ...
              return {
                type: 'Point',
                coordinates: [
                  gju.numberToDegree(lon2),
                  gju.numberToDegree(lat2),
                ],
              };
            };
          })();
